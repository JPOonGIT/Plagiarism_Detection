...
'''
train_labels_task1_bin = Data_Preprocessing.preprocessing_task1_binary(train_labels_task1)
...
test_evaluation += model.test_model(features=test_features_task1, labels=test_labels_task1_bin, loss_function=criterion)
#test_evaluation += model.test_model(features=test_features_task2, labels=test_labels_task2_bin, loss_function=criterion)